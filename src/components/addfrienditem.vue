  ...
  <transition name="frienditemT" appear>
    <div>
      <div v-show="isShow" class="frienditem">
        <!-- 头像 -->
        <img v-if="getUser.userHead" :src="`/polyhedronX/HeadsAndBacks/Heads/${getUser.userHead}`" alt="" />
        <!-- 网名,个签内容物 -->
        <div class="content">
          <!-- 名字和签名 -->
...
.writeremarksT-leave-active {
  animation: slide-in-blurred-right 0.35s cubic-bezier(0.23, 1, 0.32, 1) both reverse;
}
/* 好友个体进入退出动画 */
