<template>
  <div class="searchChatsBox">
    ...
    <div class="searchResult">
        <chats-search-re-back v-for="result of searchResult" :key="result.chatId" :resultProps="result"></chats-search-re-back>
...
import ChatsSearchReBack from './chatsSearchReBack.vue'
export default {
  components: { SearchChatsLoading, ChatsSearchReBack },
name:'searchChatsBack',
props:['friendProps','userProp'],
data(){
    return{
