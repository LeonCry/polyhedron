  ...
  <div class="replybox">
    ...
    <div class="myhead">
      ...
      <div class="usernametime">
        <span style="color:seagreen">{{replys.user.userName}}<span style="color:seagreen">#{{replys.myFloor}}层</span></span>
    ...
    <!-- 评论内容 -->
    <div class="content">
      <span style="color:#409EFF">回复 @{{replys.targetUser.userName}}#{{replys.replyTargetFloor}}{{floorOrLayer}}: </span>{{replys.replyContent}}
    </div>
  </div>
</template>
...
.content {
  ...
  padding: 10px;
  margin-top: 10px;
  border-bottom: 1px seagreen dashed;
  border-left: 1px seagreen dashed;
}
/* 写评论 */
.writecomment {
  position: relative;
