      ...
      <transition name="DetailT-1">
        <div class="order">
          ...
          <div class="detailimgs">
            <img src="https://img.zgxledu.com/UpFiles/gp/1000/202202/18/122323349370.jpg" alt="" />
          </div>
...
export default {
  ...
  mounted() {
    this.$bus.$on('allOrderShow', (data) => {
      this.isDetail = true
      var price = 0
      this.$axios.post('/api/selectFoodOrdersByName', { orderPerson: data.orderUser }).then(
        (response) => {
